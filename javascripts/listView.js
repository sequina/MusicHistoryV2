...
//Putting songs into DOM
  function loadSongs (songs) {
    for (let song in songs) {
      console.log(song);
      // console.log("i", i);
      $("#list-view").append("<div id = '"+ song + "' class = 'list-view'><h2>" + songs[song].artist + "</h2><h3>" + songs[song].album + "</h3><div>" + songs[song].title + "</div><button class = 'del'>Delete</button></div>");
